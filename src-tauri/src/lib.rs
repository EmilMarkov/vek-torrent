...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::add_external_to_folder,
            commands::remove_external_from_folder,
            commands::external_torrents,
            commands::add_external_torrent,
            commands::remove_external_torrent,
            commands::download_external_torrent,
            commands::history,
